...
@WebServlet("/LogSearchByUname")
public class LogSearchByUname extends HttpServlet {

	private static final long serialVersionUID = 1L;

	public LogSearchByUname() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<OperLog> operlist = operLogService.findByUserName(name);
