...
<html>
  <head>
    ...
    <title>My JSP 'InfoManager.jsp' starting page</title>
...
<br>
          ...
          <form action="AlterUserDetail" class="formm" method="POST" id="form1" onsubmit="return checkform()" enctype="multipart/form-data">
     修改常规信息：<br>
     ...
     性 &nbsp 别：<input type="text" name="sex" id="sex" value="${user.sex}">
...
<br>
     ...
     <br>
     <div style="float: right;"><button class="smallButton" type="reset">重  置</button>
