...
${error}
    <div class="titlee"><img src="img/addBlog.png" style="height:85px"></div>
        <form action="AlterArtical" class="content" method="post" onsubmit="return Blogcheck()">
        <br><br>
            <div style="text-align:center">
                题目:
                <input type="text" name="title" id="title" value="${blog.title}" class="addBlogTitle">
                <br>
            </div>
            <br>
            <div style="text-align:center">
            <input type="hidden" value="${blog.blogId}" name="blogId">
                类别:<select name="blogType" class="addBlogTitle">
